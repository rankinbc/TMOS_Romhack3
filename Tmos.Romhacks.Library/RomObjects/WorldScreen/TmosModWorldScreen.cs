...
using Tmos.Romhacks.Library.Enum.WorldScreen;
...
namespace Tmos.Romhacks.Library.RomObjects.WorldScreen
{
    public class TmosModWorldScreen : IRomDataObserver
    {
        ...
        {
            return WSColor.GetColor(WorldScreenColor);
		}
