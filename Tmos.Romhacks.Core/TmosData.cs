...
namespace Tmos.Romhacks.Core
{
    public static class TmosData//: ITmosData
	{
        ...
        public static T GetDataObject<T>(byte[] rom, int index, TmosRomObjectType objectType, int offset = 0) where T : new()
        {
            ...
            return (T)Activator.CreateInstance(typeof(T), selectedData);
        }
