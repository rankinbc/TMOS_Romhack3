...
using Tmos.Romhacks.Forms.Drawing;
...
namespace Tmos.Romhacks.Forms
{
    ...
    public partial class Form1 : Form
    {
        ...
        private readonly TmosModRom _tmosModRom;

        private TmosModRomContent RomContent => _tmosModRom.RomContent;
        ...
        //private readonly TmosModRom _tmosEditorRom;
        public Form1(TmosModRom tmosEditorRom, IWorldScreenGridGenerator gridGenerator)
        {
            _tmosModRom = tmosEditorRom;
        ...
        {
            TmosModTile selectedTile = RomContent.Tiles[_userControlState.SelectedTileIndex.Value];
        ...
        {
            //pb_worldMap.DrawOptions.TileSize = (int)nud_drawOptions_map_tileSize.Value;
            Draw();
        }
        ...
        {
            _tmosModRom.SaveDataToRom(path);
        ...
        {
            var items = RomContent.WorldScreens
                .Select((ws, i) =>
                {
        ...
        private void UpdateWorldScreenTileListBox()
        {
            PopulateListBox(lb_worldScreenTiles,
                RomContent.WorldScreenTiles.Select((tile, index) =>
        ...
        private void UpdateTileListBox()
        {
            PopulateListBox(lb_tile,
                RomContent.Tiles.Select((_, index) =>
        ...
        private void UpdateMiniTileListBox()
        {
            PopulateListBox(lb_miniTile,
                RomContent.MiniTiles.Select((_, index) =>
                    ByteDisplayUtility.ToDecimalAndHexDisplayValue(index)));
        }
        ...
        private void UpdateRandomEncounterGroupsListBox()
        {
            PopulateListBox(lb_encounterGroups,
                RomContent.RandomEncounterGroups.Select((_, index) =>
                    ByteDisplayUtility.ToDecimalAndHexDisplayValue(index)));
        }
        ...
        private void UpdateRandomEncounterLineupsListListBox()
        {
            PopulateListBox(lb_encounterLinups,
                RomContent.RandomEncounterLineups.Select((_, index) =>
                    ByteDisplayUtility.ToDecimalAndHexDisplayValue(index)));
        }

        private void UpdateEncounterLineupEnemyListBox()
        {
            if (_userControlState.SelectedRandomEncounterLineupIndex != null)
            {

                TmosModRandomEncounterLineup selectedEncounterLineup = RomContent.RandomEncounterLineups[(int)_userControlState.SelectedRandomEncounterLineupIndex];
                PopulateListBox(lb_encounterLineup_encounterEnemies, new EncounterEnemy[]
                {
                    selectedEncounterLineup.EncounterEnemySlot1,
                    selectedEncounterLineup.EncounterEnemySlot2,
                    selectedEncounterLineup.EncounterEnemySlot3,
                    selectedEncounterLineup.EncounterEnemySlot4,
                    selectedEncounterLineup.EncounterEnemySlot5,
                    selectedEncounterLineup.EncounterEnemySlot6
                }.Select((ee, index) => ee == null ? "--" : ee.Name));
            }
        }
        ...
        private void UpdateTileSectionListBox()
        {
            PopulateListBox(lb_tileSection,
                RomContent.TileSections.Select((_, index) =>
                    ByteDisplayUtility.ToDecimalAndHexDisplayValue(index)));
        }
        ...
        {
            var items = RomContent.GameVariables
                .Select((kvp, i) =>
                {
                    GameVariableEnum key = kvp.Key;
                    var v = RomContent.GameVariables[key];
        ...
        {
            _userControlState.SelectWorldMapGridCell(gridPosition.X, gridPosition.Y, _worldScreenGrid);
        ...
        private void SelectWorldScreen(int absoluteWorldScreenIndex)
        {
            ...
            else if (lv_worldScreens.SelectedIndices.Count == 0 || lv_worldScreens.SelectedIndices[0] != absoluteWorldScreenIndex)
            {
            ...
            else
            {
                ...
                TmosModWorldScreen selectedScreen = RomContent.WorldScreens[absoluteWorldScreenIndex];
        ...
        {
            _worldScreenGrid = _gridGenerator.LoadWorldScreenGrid(startingWSIndex);
        ...
        {
            int selectedItem = (int)_userControlState.SelectedTileSectionIndex;
            SelectItem(
                ref selectedItem,
                lb_tileSection.SelectedIndex,
                SelectTileSection,
                _tmosModRom.GetTmosModTileSection,
                () =>
                {
                    _userControlState.SelectedTileSectionIndex = selectedItem;
                    gb_tileSection.Text = $"TileSection: {selectedItem}";
                    UpdateTileSectionDataListView(_tmosModRom.GetTmosModTileSection(selectedItem));
                    Draw();
                }
            );
        }
        ...
        {
            int selectedItem = (int)_userControlState.SelectedTileIndex;
            SelectItem(
                ref selectedItem,
                lb_tile.SelectedIndex,
                SelectTile,
                _tmosModRom.GetTmosModTile,
                () =>
                {
                    _userControlState.SelectedTileIndex = selectedItem;
        ...
        {
            int selectedItem = (int)_userControlState.SelectedMiniTileIndex;
            SelectItem(
                ref selectedItem,
                lb_miniTile.SelectedIndex,
                SelectMiniTile,
                index => RomContent.MiniTiles[index],
                () =>
                {
                    _userControlState.SelectedMiniTileIndex = selectedItem;
        ...
        {
            int selectedItem = _userControlState.SelectedRandomEncounterGroupIndex.Value;
            SelectItem(
                ref selectedItem,
                lb_encounterGroups.SelectedIndex,
                SelectRandomEncounterGroup,
                index => RomContent.RandomEncounterGroups[index],
                () =>
                {
                    _userControlState.SelectedRandomEncounterGroupIndex = selectedItem;
        ...
        private void lb_encounterLinups_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SelectItem(
                ...
                index => RomContent.RandomEncounterLineups[index],
                () =>
                {
                    _userControlState.SelectedRandomEncounterLineupIndex = selectedItem;
                    gb_encounterLineups.Text = $"Encounter Lineup: {selectedItem}";

                    UpdateEncounterLineupEnemyListBox();
                }
            );
        }
        ...
        private void lb_encounterEnemies_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void btn_knownVariables_selectedVariable_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _tmosModRom.UpdateGameVariable(selectedGameVariableEnum, newVariableValue);
        ...
        private void SelectTile(TmosModTile tile)
        {
            ...
            SelectMiniTile(RomContent.MiniTiles[tile.MiniTile_TopLeft]);
        }
        ...
        private void SelectRandomEncounterLinuep(TmosModRandomEncounterLineup lineup)
        {
            rtb_encounterLineups_data.Clear();
            rtb_encounterLineups_data.Text = string.Join(" ", lineup.GetBytes().Select(b => b.ToString("X2")));
        }
        ...
        {
            int currentChapter = ChapterUtility.GetChapterOfWorldScreen(_userControlState.SelectedWorldScreenIndex.Value).ChapterNumber;
        ...
        private void comboBox_worldScreen_content_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox_worldScreen_content.SelectedIndex != _selectedWorldScreenContentIndex)
            {
                ...
                if (_userControlState.SelectedWorldScreenIndex != null)
                {
        ...
        {
            int chapter = _tmosModRom.GetTmosWorldScreenChapter((int)_userControlState.SelectedWorldScreenIndex);
            int relativeWorldScreenIndex = ByteDisplayUtility.HexStringToInt(tb_direction_up.Text);
            int neightborWSIndex = _tmosModRom.GetTmosWorldScreenNeighborAbsoluteIndex(chapter, relativeWorldScreenIndex, Direction.Up);
        ...
        private void btn_move_right_Click(object sender, EventArgs e)
        {
            ...
            int neightborWSIndex = _tmosModRom.GetTmosWorldScreenNeighborAbsoluteIndex(chapter, relativeWorldScreenIndex, Direction.Right);
        ...
        private void btn_move_left_Click(object sender, EventArgs e)
        {
            ...
            int neightborWSIndex = _tmosModRom.GetTmosWorldScreenNeighborAbsoluteIndex(chapter, relativeWorldScreenIndex, Direction.Left);
        ...
        private void btn_move_down_Click(object sender, EventArgs e)
        {
            ...
            int neightborWSIndex = _tmosModRom.GetTmosWorldScreenNeighborAbsoluteIndex(chapter, relativeWorldScreenIndex, Direction.Down);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int chapter = ChapterUtility.GetChapterOfWorldScreen(_userControlState.SelectedWorldScreenIndex.Value).ChapterNumber;
            try
            {
                ...
                _tmosModRom.UpdateTmosModWorldScreen(_userControlState.SelectedWorldScreenIndex.Value, currentWS);
                _tmosModRom.UpdateTmosModWorldScreen(screenIndexUpAbsoluteWorldScreenIndex, destinationWS);
            }
            catch { }
            ...
            try
            {
                ...
                _tmosModRom.UpdateTmosModWorldScreen(_userControlState.SelectedWorldScreenIndex.Value, currentWS);
                _tmosModRom.UpdateTmosModWorldScreen(screenIndexDownAbsoluteWorldScreenIndex, destinationWS);
            }
            catch { }
            ...
            try
            {
                ...
                _tmosModRom.UpdateTmosModWorldScreen(_userControlState.SelectedWorldScreenIndex.Value, currentWS);
                _tmosModRom.UpdateTmosModWorldScreen(screenIndexRightAbsoluteWorldScreenIndex, destinationWS);
            ...
            try
            {
                ...
                _tmosModRom.UpdateTmosModWorldScreen(_userControlState.SelectedWorldScreenIndex.Value, currentWS);
                _tmosModRom.UpdateTmosModWorldScreen(screenIndexLeftAbsoluteWorldScreenIndex, destinationWS);
            }
            catch { }
        ...
        {
            int chapter = _tmosModRom.GetTmosWorldScreenChapter(_userControlState.SelectedWorldScreenIndex.Value);
            int absoluteIndex = WSIndexUtility.GetAbsoluteWorldScreenIndex(chapter, _userControlState.SelectedWorldScreenIndex.Value);
        ...
        private void DrawMap()
        {
            if (_renderingEnabled)
            {
                var wsDrawOptions = _drawingManager.GetDrawOptions(
                    ...
                    Convert.ToInt32(nud_drawOptions_map_tileSize.Value),
                ...
                //TmosModWorldScreen ws = RomContent.WorldScreens[_userControlState.SelectedWorldScreenIndex ?? 0];
                //Reload grid


                _drawingManager.DrawMap(pb_worldMap, _worldScreenGrid, (int)nud_drawOptions_map_tileSize.Value, GetDrawOptions(), _userControlState);
            }
        }
        ...
        private void btn_tileSection_data_save_Click(object sender, EventArgs e)
        {
            ...
            _tmosModRom.UpdateTmosModTileSection(_userControlState.SelectedTileSectionIndex.Value, newData);
        ...
        private void btn_tile_save_Click(object sender, EventArgs e)
        {
            ...
            _tmosModRom.UpdateTmosModTile(_userControlState.SelectedTileIndex.Value, updatedTile.GetBytes());
        }
        ...
        private void btn_miniTile_save_Click(object sender, EventArgs e)
        {
            ...
            _tmosModRom.UpdateMiniTile(_userControlState.SelectedTileIndex.Value, updatedTile.GetBytes());
        }
        ...
        {
            TmosModRandomEncounterLineup updatedEncounterLineup = new TmosModRandomEncounterLineup(
                new byte[]
                {
        ...
        private void pb_worldMap_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else //Left click
                {
                    ...
                    {
                        MoveWorldScreen(_userControlState.SelectedWorldMapGridCell_Secondary.Value.X, _userControlState.SelectedWorldMapGridCell_Secondary.Value.Y, gridCellClickedX, gridCellClickedY);
        ...
        {
            _userControlState.SelectWorldMapGridCell(x, y, _worldScreenGrid);
            ...
            if (lv_worldScreens.Items.Count > 0)
            {
                ...
                if (!wsGridCell.IsEmpty())
                {
                    ...
                    lv_worldScreens.TopItem = lv_worldScreens.Items[_userControlState.SelectedWorldScreenIndex.Value];
                    lv_worldScreens.Select();
                }
                else
                {
        ...
        private void shuffleTileSectionsKeepCompatableToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            while (!complete)
            {
                ...
                currentWS = RomContent.WorldScreens[_userControlState.SelectedWorldScreenIndex.Value];
